...
* **Update 1**: Microsoft Edge-like vertical tab is now supported | Enable by adding new Boolean preference in `about:config`: `uc.tweak.autohide-sidebar` and put codes from [edgemode-sidebery](./edgemode-sidebery) on Sidebery style editor.
